...
uint256 hashGenesisBlock("0x0fceb6146f6e7b215281f0e16563d147f1d5beeef252617cf4727045f16114d6");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Ethereumgold: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Ethereumgold: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // Ethereumgold: 30 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0fceb6146f6e7b215281f0e16563d147f1d5beeef252617cf4727045f16114d6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is Gols";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a7e4d3eb4b10f3d4604fa08dce602aaf0f470215fe1b51850b4acf21b179c25070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1512813107;
        ...
        assert(block.hashMerkleRoot == uint256("0x3ab4ed56c25f67df737ecde2e385d646d401d660f4afe0e698e150ced527661e"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Ethereumgold: increase each by adding 2 to bitcoin's value.
